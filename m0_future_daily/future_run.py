    ...
    with tf.Graph().as_default():
        ...
        for step in range(FLAGS.max_steps):
            ...
            if (step + 1) % 1000 == 0 or (step + 1) == FLAGS.max_steps:
                ...
                print(sess.run(prediction, feed_dict={features_placeholder: test_features}))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='.\savedir', help='Directory to put the log data.')
