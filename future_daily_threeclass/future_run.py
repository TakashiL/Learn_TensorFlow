...
import time
import numpy as np
from future_daily_threeclass.data_process import read_data
from future_daily_threeclass.future_model import *
...
def placeholder_inputs(batch_size):
    """
    Args:
        batch_size: The size will be baked into both placeholders.
    Returns:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='.\savedir/three_class', help='Directory to put the log data.')
